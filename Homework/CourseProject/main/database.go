...
func longLinkToShortLink(longLink string, header string) string {
	...
	_ = tx.Commit()
	resultstring := longIntToShortLink(linkIndex)
	result1 := resultstring + header
	return result1
}
